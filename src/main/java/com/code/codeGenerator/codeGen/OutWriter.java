...
public class OutWriter {
    ...
    private static final String ENTITY_TEMPLATE_FILE = "template/entity/entity.str";
    private static final String DAO_TEMPLATE_FILE = "template/dao/dao.str";
    private static final String MAPPER_TEMPLATE_FILE = "template/mapper/mapper.str";
    ...
    private static void writeEntity(List<DbTable> tableList, String outputPath) {
        ...
        for (DbTable dbTable : tableList) {
            String fileName = outputPath + "/entity/" + dbTable.getClassName() + ".java";
    ...
    private static void writeXml(List<DbTable> tableList, String outputPath) {
        Generator generator = new Generator();
        for (DbTable dbTable : tableList) {
            String fileName = outputPath + "/xml/" + dbTable.getClassName() + ".xml";
